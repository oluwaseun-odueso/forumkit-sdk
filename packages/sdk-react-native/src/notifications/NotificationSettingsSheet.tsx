...
import { Modal, View, Text, Pressable, Switch, ActivityIndicator, StyleSheet } from 'react-native';
      ...
      <Pressable style={styles.scrim} onPress={onClose}>
        <Pressable style={[styles.sheet, { backgroundColor: tokens.elev, borderColor: tokens.border }]} onPress={() => {}}>
          ...
          {loading || !prefs ? (
            ...
            rows.map(row => (
              <View key={row.key} style={[styles.row, { borderTopColor: tokens.border }]}>
                ...
                <Switch
                  ...
                  trackColor={{ true: tokens.accent, false: tokens['surface-2'] }}
                />
              </View>
            ))
          )}
